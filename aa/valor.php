...
<source src="nebu.mp4" type="video/mp4">
	...
	<div class="navegacion">
			<nav>
				...
				<div class="container">
			<h2 align="center">Valor de un curso</h2>
			<form action="valor.php" method="post" class="curso-form">
				Costo del curso: <input type="number" name="Costo"placeholder="Ingrese costo del curso" required><br>
				
				
			<input type="submit" name="submit" value=" Calcular valor del curso ">
			
			</form>
			<?php
			if (isset($_POST['submit'])) {
			$Costodelcurso = $_POST['Costo'];
			
			
			$Cursodedia = $Costodelcurso;
			$Cursodenoche = $Costodelcurso+($Costodelcurso*0.05);
			echo "<p class ='resultado'> El costo del curso de dia es;" . $Cursodedia;
			echo "<p class ='resultado'> El costo del curso de noche es;" . $Cursodenoche;
			}
			?>	
</div>
 <footer><b>
