...
<source src="nebu.mp4" type="video/mp4">
	...
	<div class="navegacion">
			<nav>
				...
				<div class="container">
			<h2 align="center">Solucion de ecuaciones de la forma ax + b = y.</h2>
			<form action="solucion.php" method="post" class="ecuacion-form">
				a: <input type="number" name="a"placeholder="Ingrese a" required><br>
				b: <input type="number" name="b" placeholder="Ingrese b"required><br>
				y: <input type="number" name="y" placeholder="Ingrese y"required><br>
				
			<input type="submit" name="submit" value="Calcular ecuacion ax+b=y">
			...
			$y = $_POST['y'];
			$x = ($y-$b)/$a;
			echo "<p class ='resultado'> La solucion de la ecuacion de la forma ax + b = y es ;" . $x;
			}
			?>	
</div>
 <footer><b>
