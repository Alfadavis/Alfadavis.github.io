...
<div class="navegacion">
			<nav>
			 ...
			 <div class="container">
<h1>Descuento de venta </h1> <form action="descuento.php" method="post">
 Precio de la compra: <input type="number" name="pc" required placeholder="Ingrese precio de su compra" ><br>
...
$T= $C-$D;
      ...
      echo "<p> = El precio total a pagar es " . $T . "</p>";
...
$T1= $C-$D1;
      ...
      echo "<p> = El precio total a pagar es " . $T1 . "</p>";
