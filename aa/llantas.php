...
<div class="navegacion">
		...
		<div class="container">
<h1>El precio de las llantas </h1> <form action="llantas.php" method="post">
 Llantas: <input type="number" name="llantas" required placeholder="Ingrese número de llantas" ><br>
...
if (isset($_POST['submit'])) {
   $Llantas = $_POST['llantas'];
    ...
    if ($Llantas >= 5) {
      $p1 =  ($Llantas*70000) ;  
      echo "<p>El precio de las llantas es =  " . $p1 . "</p>";
} elseif ($Llantas<5) {
 $p2= ($Llantas*80000);
 echo "<p>El precio de las llantas es =  " . $p2 . "</p>";
 }
