...
<source src="nebu.mp4" type="video/mp4">
	...
	<div class="navegacion">
		...
		<div class="container">
			<h2 align="center">Precio de un recibo de la luz</h2>
			<form action="precio.php" method="post" class="precio-form">
				Cantidad de kWh consumidos <input type="number" name="kWh"placeholder="Ingrese cantidad de kWh consumidos" required><br>
			...
			$Factura = $kWh*817.8;
			echo "<p class ='resultado'> El precio de la factura es;" . $Factura;
