...
<div class="navegacion">
			...
			<div class="container">
<h1>Descuento de la promoción en supermercado </h1> <form action="superm.php" method="post">
 Valor de compra: <input type="number" name="compra" required placeholder="Ingrese el valor de la compra" ><br>
 N° promoción: <input type="number" name="pro" required placeholder="Ingrese N° de promoción" ><br>
...
if (isset($_POST['submit'])) {
   ...
   $pro = $_POST['pro'];
    ...
    if ($pro >= 74) {
      $v1 =  ($Compra*20)/100 ;
      $d1=   $Compra-$v1;  
      echo "<p>El valor total  es =  " . $v1 . "</p>";
      echo "<p>El valor total con descuento  es =  " . $d1 . "</p>";
} elseif ($pro<74) {
 $v2= ($Compra*15)/100;
 $d2= $Compra-$v2;

 echo "<p>El valor total  es =  " . $v2 . "</p>";
      echo "<p>El valor total con descuento  es =  " . $d2 . "</p>";
 }
