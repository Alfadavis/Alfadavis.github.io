...
<source src="nebu.mp4" type="video/mp4">
	...
	<div class="navegacion">
			<nav>
				...
				<div class="container">
			<h2 align="center">Volumen de una esfera</h2>
			<form action="volumen.php" method="post" class="volumen-form">
				Radio: <input type="number" name="Radio"placeholder="Ingrese el Radio" required><br>
			...
			echo "<p class ='resultado'> El Volumen de la esfera es;" . $Volumen;
			}
			?>	
</div>
 <footer><b>
