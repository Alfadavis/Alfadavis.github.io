...
<div class="navegacion">
  ...
  <div class="container">
<h1>Pago al SAR </h1> <form action="SAR.php" method="post">
 Ingrese % que depositará: <input type="number" name="ing" required placeholder="Ingrese %" ><br>
...
if (isset($_POST['submit'])) {
   ...
   $Pago= 1200000-$des;
      ...
      echo "<p>El trabajador depositara a las SAR =  " . $des. "</p>";
      echo "<p>El pago mensual que recibira es =  " . $Pago . "</p>";
