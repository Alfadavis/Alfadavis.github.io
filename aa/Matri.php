...
<div class="container">
<h1>Costo de matricula </h1> <form action="Matri.php" method="post">
 Materias: <input type="number" name="m" required placeholder="Ingrese N° materias que quiere cursar" ><br>
 Ingrese sus ultimas notas: <input type="number" name="m" required placeholder="Ingrese nota" ><br>
  <input type="number" name="a" required placeholder="Ingrese nota" ><br>
  <input type="number" name="b" required placeholder="Ingrese nota" ><br>
  <input type="number" name="c" required placeholder="Ingrese nota" ><br>
 <input type="number" name="d" required placeholder="Ingrese nota" ><br>
 <input type="number" name="e" required placeholder="Ingrese nota" ><br>
...
if (isset($_POST['submit'])) {
   ...
   $p= ($a+$b+$c+$d+$e)/5;
	  ...
	  echo "<p>La cuota inicial es =  " . $c1 . "</p>";
      echo "<p>Su promedio es =  " . $p . "</p>";
    
    if ($p >= 45) {
      $des =  ($c1*30/100) ;  
      $tm= ($c1-$des);
       echo "<p>El precio total es =  " . $des . "</p>";
      echo "<p>El precio con descuento es =  " . $tm . "</p>";
      
} elseif ($p<45) {
 $iva =  ($c1*10/100) ;  
      $t2= ($iva+$c1);
      echo "<p>El precio total es =  " . $iva . "</p>";
      echo "<p>El preciototal con iva es =  " . $t2 . "</p>";
