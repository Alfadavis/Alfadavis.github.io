...
<div class="navegacion">
  ...
  <div class="container">
<h1>2X2 </h1> <form action="2x2.php" method="post">
 
a: <input type="number" name="a"placeholder="Ingrese a" required><br>
b: <input type="number" name="b"placeholder="Ingrese b" required><br>
c: <input type="number" name="c"placeholder="Ingrese c" required><br>
d: <input type="number" name="d"placeholder="Ingrese d" required><br>
e: <input type="number" name="e"placeholder="Ingrese e" required><br>
f: <input type="number" name="f"placeholder="Ingrese f" required><br>
