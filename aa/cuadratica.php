...
<div class="container">
<h1>Resolver ecuación cuadrática</h1> <form action="cuadratica.php" method="post">
Coeficiente a: <input type="number" name="a" required placeholder="Ingrese a" ><br>
Coeficiente b: <input type="number" name="b" required placeholder="Ingrese b"><br>
Coeficiente c: <input type="number" name="c" required placeholder="Ingrese c"><br>
...
if (isset($_POST['submit'])) {
   ...
   if ($discriminante > 0) {
      ...
      echo "<p>La ecuación tiene dos soluciones reales: x1 =  " . $x1 . "
       , x2 = " . $x2 . "</p>";
