...
<source src="nebu.mp4" type="video/mp4">
	...
	<div class="navegacion">
			<nav>
				...
				<div class="container">
			<h2 align="center">Velocidad de un movil con MRVA</h2>
			<form action="velocidad.php" method="post" class="mrva-form">
				Distancia: <input type="number" name="Distancia"placeholder="Ingrese Distancia" required><br>
				Tiempo: <input type="number" name="Tiempo" placeholder="Ingrese Tiempo"required><br>
				
			<input type="submit" name="submit" value="Calcular velocidad con MRVA">
			...
			$MRVA = $Distancia/$Tiempo;
			echo "<p class ='resultado'> La velocidad del movil es;" . $MRVA;
			}
			?>	
</div>
 <footer><b>
