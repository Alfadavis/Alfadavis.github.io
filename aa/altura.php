...
<source src="nebu.mp4" type="video/mp4">
	...
	<div class="navegacion">
		...
		<div class="container">
			<h2 align="center">Altura de una caida</h2>
			<form action="altura.php" method="post" class="area-form">
				Tiempo: <input type="number" name="t"placeholder="Ingrese el tiempo" required><br>
				
				
				
			<input type="submit" name="submit" value="Calcular Altura">
			...
			$Altura =  (1/2) * 9.8^2 * ($Tiempo^2)^2;
			echo "<p class ='resultado'> La altura de la caida es;" . $Altura;
