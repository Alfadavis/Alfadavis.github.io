...
<source src="nebu.mp4" type="video/mp4">
	...
	<br>
		<div class="container">
			<h2 align="center">PROMEDIO DE 5 NOTAS</h2>
			<form action="promedio.php" method="post" class="nota-form">
				Nota 1: <input type="number" name="nota1"placeholder="Ingrese un número" required><br>
				Nota 2: <input type="number" name="nota2" placeholder="Ingrese un número"required><br>
				Nota 3: <input type="number" name="nota3" placeholder="Ingrese un número"required><br>
				Nota 4:<input type="number" name="nota4" placeholder="Ingrese un número" required><br>
				Nota 5: <input type="number" name="nota5" placeholder="Ingrese un número"required><br>
			...
			echo "<p class ='resultado'> El promedio de las 5 notas es;" . $promedio;
			}
			?>	
